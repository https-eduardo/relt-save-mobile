...
export default function AppTextInput(props: TextInputProps) {
  ...
  const [passwordIcon, setPasswordIcon] = useState<keyof typeof Ionicon.glyphMap>("eye-off-outline");

  function togglePasswordVisibility() {
    setPasswordVisible(!isPasswordVisible);
    setPasswordIcon(passwordIcon !== 'eye-sharp' ? 'eye-sharp' : 'eye-off-outline');
  }
    ...
    <View style={styles.textInputContainer}>
      ...
      <View style={styles.textInputWrapper}>
        ...
        <TextInput
          ...
          secureTextEntry={props.validatorType === 'password' && !isPasswordVisible}
        />
